...
def test_create_posts(authorized_client, test_user, test_posts, title, content, publish):
    res = authorized_client.post(f"/posts/", json={"title": title, "content": content, "publish": publish})
